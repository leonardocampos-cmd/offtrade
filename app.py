...
continuam vivas em pages/ (Credito_e_Cadastro, Admin_Metas).
"""
import streamlit as st
from utils import inject_css, page_header, require_auth

st.set_page_config(page_title="Rigarr — Dashboard Comercial", page_icon="📊", layout="wide")
...
st.markdown(
    ...
    "Esta tela só existe para as páginas de Crédito e Cadastro / Admin de Metas."
)
