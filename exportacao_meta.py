...
from meta import engine, arquivo, tabela_vendas

# Busca o nome Oracle de cada vendedor pelo RCA (CODUSUR)
map_rca = pd.read_sql(
    "SELECT CODUSUR AS RCA, NOME FROM CRC.PCUSUARI WHERE NOME LIKE '%OFF TRADE%'",
    con=engine
)
